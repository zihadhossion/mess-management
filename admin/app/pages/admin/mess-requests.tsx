          ...
          {pendingMessRequests.map((req) => (
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div>
                  <h3 className="font-display font-bold text-lg text-[#2C2F1E]">
                    {req.messName}
                  </h3>
                ...
                <span className="text-[13px] font-semibold bg-amber-50 text-amber-700 px-2.5 py-1 rounded-full">
                  Pending
                </span>
              </div>
              {req.description && (
                <p className="text-[15px] text-[#6B7550] mb-2">
                  {req.description}
                </p>
              )}
              {req.address && (
                <p className="text-sm text-[#A09070] mb-3">
                  📍 {req.address}
                </p>
              )}
              <div className="flex gap-3 pt-3 border-t border-[#F0EBE0]">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 bg-[#626F47] text-[#F5ECD5] font-semibold text-[15px] py-2.5 rounded-[10px] disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                <button
                  ...
                  disabled={actionLoading === req.id}
                  className="flex-1 flex items-center justify-center gap-2 bg-red-50 text-red-600 border border-red-200 font-semibold text-[15px] py-2.5 rounded-[10px] disabled:opacity-50 disabled:cursor-not-allowed"
                >
