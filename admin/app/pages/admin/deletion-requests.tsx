          ...
          {requests.map((req) => (
            ...
            >
              ...
              <div className="bg-[#FAF7F0] rounded-[10px] p-3 mb-3">
                <p className="text-[13px] font-semibold text-[#6B7550] uppercase tracking-wider mb-1">
                  Reason
                </p>
                <p className="text-[15px] text-[#2C2F1E]">{req.reason}</p>
              </div>
              {req.status === "pending" && (
                <div className="flex gap-3 pt-3 border-t border-[#F0EBE0]">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 bg-red-600 text-white font-semibold text-[15px] py-2.5 rounded-[10px] disabled:opacity-50"
                  >
                  ...
                  <button
                    ...
                    disabled={actionLoading === req.id}
                    className="flex-1 flex items-center justify-center gap-2 bg-[#626F47] text-[#F5ECD5] font-semibold text-[15px] py-2.5 rounded-[10px] disabled:opacity-50"
                  >
