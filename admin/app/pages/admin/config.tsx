      ...
      {isLoading ? (
        ...
        <div className="space-y-4">
          <div className="bg-white border border-[#E8E0D0] rounded-[16px] p-5 shadow-[0_2px_8px_rgba(74,60,30,0.06)]">
            <h2 className="font-display font-bold text-lg text-[#2C2F1E] mb-4">
              Mess Settings
            </h2>
            <div className="space-y-4">
              <div>
          ...
          <div className="bg-white border border-[#E8E0D0] rounded-[16px] p-5 shadow-[0_2px_8px_rgba(74,60,30,0.06)]">
            ...
            <div className="space-y-3">
              {(
                ...
                >
                  <span className="text-base text-[#2C2F1E] font-medium">
                    {label}
                  </span>
                  <div
                    onClick={() =>
          ...
          <div className="bg-white border border-[#E8E0D0] rounded-[16px] p-5 shadow-[0_2px_8px_rgba(74,60,30,0.06)]">
            ...
            <label className="flex items-center justify-between cursor-pointer">
              <div>
                <span className="text-base text-[#2C2F1E] font-medium block">
                  Maintenance Mode
                </span>
                <span className="text-sm text-[#A09070]">
